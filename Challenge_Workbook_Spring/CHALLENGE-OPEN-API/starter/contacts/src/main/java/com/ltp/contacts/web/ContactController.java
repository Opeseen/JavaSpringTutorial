...
@RestController
@Tag(name = "Contact Controller", description = "Create and retrieve contact")
public class ContactController {
    ...
    @ApiResponse(responseCode = "200", description = "Successful retrieval of all contacts", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Contact.class))))
